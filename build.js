...
<body>
    ...
    <footer>
        ...
        <p style="font-size: 0.8em; color: #58a6ff;">ETH: 0xaAe0571DFEC8BC107571f6488831a7dcc21A6861</p>
    </footer>
</body>
</html>
`;
...
async function main() {
    ...
    if (!fs.existsSync(MEMORY_DIR)) {
        console.error('❌ No memory directory found!');
        process.exit(1);
    }
